...
A request for salary information for a department is sent to HR.

## MAIN SUCCESS SCENARIO

1. Finance requests salary information for a specific department.
2. HR advisor captures the name of the department.
3. HR advisor extracts current salary information of all employees in the selected department.
